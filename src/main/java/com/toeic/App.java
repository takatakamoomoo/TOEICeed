...
public class App extends Application {
    ...
    private class ExitProcess extends Task<Void> {
        ...
        protected Void call() throws Exception {
            ...
            try {
                excelFileOperationt.updateExcelFile(excelFileName, excelSheetName);
            } catch (IOException e) {
                e.printStackTrace();
            }
            Platform.exit();
    ...
    private class ExcelFileRead extends Task<Void>  {
        ...
        protected Void call() throws Exception {
            ...
            excelSheetName = property.getProperty("excelSheetName");

            try {
                excelFileOperationt.createPartList(excelFileName, excelSheetName, labelStatus);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return null;
